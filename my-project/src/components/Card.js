    ...
    <div className="bg-white h-5/6 grid grid-cols-1 lg:grid-cols-2 p-5">
      ...
      <div className="calculator-part flex flex-col gap-3">
        ...
        <div className="relative">
          <svg xmlns="http://www.w3.org/2000/svg" width="11" height="17" className="absolute h-full m-3">
            <path
              fill="#9EBBBD"
        ...
        <div className="flex w-full">
          <input type="text" className="bg-lightGrayishCyan  w-choSir h-10" />
        </div>
      </div>

      {/* Result Part */}
      <div className="gap-5 result-part bg-veryDarkCyan p-5 pt-7 rounded-md flex flex-col justify-evenly  ">
        ...
        {/* Reset button */}
        <div className="reset w-full bg-grayishCyan rounded-md text-center py-3 ">
